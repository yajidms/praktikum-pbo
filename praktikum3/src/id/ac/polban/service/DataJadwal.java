...
import id.ac.polban.model.JadwalKuliah;
import id.ac.polban.model.MataKuliah;

/**
 * DataJadwal berperan sebagai Factory (penyedia data) menggunakan method static.
 * Relasi:
 * - Dependency terhadap JadwalKuliah & MataKuliah (membuat dan mengembalikan objek-objek tersebut).
 */
public class DataJadwal {
  public static final String DEFAULT_KELAS = "2C-D3"; // contoh static constant
